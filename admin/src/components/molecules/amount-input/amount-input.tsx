...
const AmountInput = ({
  ...
  return (
    <div>
      ...
      <div
        className={clsx(
          "w-full flex items-center bg-grey-5 border border-gray-20 px-base py-xsmall rounded-rounded h-10 focus-within:shadow-input focus-within:border-blue-60 inter-base-regular",
          {
