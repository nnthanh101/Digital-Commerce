    ...
    <form className="flex flex-col flex-1" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-base flex-1">
        ...
        <div className="flex item-center gap-x-1.5">
          ...
          <IconTooltip
            content={
              "When checked eCommerce will automatically apply tax calculations to Carts in this Region. When unchecked you will have to manually compute taxes at checkout. Manual taxes are recommended if using a 3rd party tax provider to avoid performing too many requests"
            }
          />
        </div>
        <div className="flex item-center gap-x-1.5">
