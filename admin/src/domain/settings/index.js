...
const SettingsIndex = () => {
  return (
    <SettingsOverview>
      ...
      <SettingsCard
        heading={"The Team"}
        description={"Manage users of your eCommerce Store"}
        icon={<UsersIcon />}
        to={`/a/settings/team`}
      />
      <SettingsCard
        heading={"Personal Information"}
        description={"Mange your eCommerce Profile"}
        icon={<HappyIcon />}
        to={`/a/settings/personal-information`}
      />
      <SettingsCard
        heading={"admin@oceansoft.io"}
        description={"Can’t find the answers you’re looking for?"}
        icon={<MailIcon />}
        externalLink={"mailto: admin@oceansoft.io"}
      />
      <SettingsCard
